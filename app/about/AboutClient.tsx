...
export default function AboutClient({ content }: Props) {
  ...
  const values = [
    { icon: '/icons/target.svg', title: getVal('about.value_1', 'Ethics, Integrity & Excellence'), desc: 'We uphold the highest standards of ethical conduct in all our dealings.' },
    { icon: '/icons/target.svg', title: getVal('about.value_2', 'Professionalism'), desc: 'We maintain professional standards across all our operations and partnerships.' },
    { icon: '/icons/target.svg', title: getVal('about.value_3', 'Sustainability'), desc: 'We promote sustainable agriculture that protects our environment for future generations.' },
    { icon: '/icons/target.svg', title: getVal('about.value_4', 'Total Quality Management'), desc: 'Quality is at the core of every product and service we deliver.' },
    { icon: '/icons/target.svg', title: getVal('about.value_5', 'Productivity'), desc: 'We continuously seek ways to improve output and efficiency.' },
    { icon: '/icons/target.svg', title: getVal('about.value_6', 'Continuous Improvement'), desc: 'We learn, adapt and improve in everything we do.' },
    { icon: '/icons/target.svg', title: getVal('about.value_7', 'Efficiency & Effectiveness'), desc: 'We deliver results efficiently, maximizing value for all stakeholders.' },
  ];
  ...
  return (
    <>
      <div className="page-hero">
        ...
        <h1>{getVal('about.hero.title', 'About Musikuli Dairies Limited')}</h1>
        <p>{getVal('about.hero.subtitle', 'A family-built company committed to quality, sustainability and community empowerment across Uganda.')}</p>
      </div>
        ...
        <div className="container">
          <div className="about-grid">
            <div className="about-image-wrapper">
              <Image
                src={getVal('about.founder_2.image', '/images/founders pic.jpeg')}
            ...
            <ScrollAnimation>
              <div className="mission-card mission-card-blue">
                ...
                <p className="mission-text">
                  {getVal('about.mission', 'To be the premier supplier of agricultural products and milk, building long-term relationships with our customers through consistent supply of quality products while promoting sustainable agriculture.')}
                </p>
              </div>
            </ScrollAnimation>
            <ScrollAnimation delay={200}>
              <div className="mission-card mission-card-green">
                ...
                <p className="mission-text">
                  {getVal('about.vision', "To be the market leader of affordable high-quality agro products in Uganda, contributing to Uganda's economic and social development.")}
                </p>
              </div>
            </ScrollAnimation>
          </div>
      ...
      <section className="contact-section">
        <div className="container text-center">
          ...
          <div className="contact-flex">
            {[
              { icon: '/icons/target.svg', label: 'Address', val: getVal('about.contact.address', 'Nsozibirye-Kigombe, Luwero Sub County, Luwero District, Uganda') },
              { icon: '/icons/mailbox.svg', label: 'P.O Box', val: getVal('about.contact.pobox', 'P.O Box 170174, Kampala') },
              { icon: '/icons/phone.svg', label: 'Telephone', val: getVal('about.contact.phone', '+256 200 933 861') },
              { icon: '/icons/email.svg', label: 'Email', val: getVal('about.contact.email', 'info@musikulidairies.com') }
            ].map((c, i) => (
