...
export default function ContactClient({ content }: Props) {
  ...
  const phone = getVal('contact.phone', '+256 200 933 861');
  const cleanPhone = phone.replace(/\s+/g, '');
  const email = getVal('contact.email', 'info@musikulidairies.com');
  const whatsapp = getVal('contact.whatsapp', '256200933861');
  const address = getVal('contact.address', 'Nsozibirye Village, Kigombe Parish, Luwero Sub County, Luwero District, Uganda');
  const pobox = getVal('contact.pobox', 'P.O Box 170174, Luwero-Uganda');
  const hours = getVal('contact.hours', 'Monday – Saturday: 7:00 AM – 6:00 PM');
  const mapsEmbed = getVal('contact.maps_embed', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63678.43247756754!2d32.421!3d0.824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177b0b3be5e4e5a7%3A0x5d10f8a4f0e2e3a5!2sLuwero%2C%20Uganda!5e0!3m2!1sen!2s!4v1716700000000!5m2!1sen!2s');
  ...
  return (
    <>
      <div className="page-hero">
        ...
        <h1>{getVal('contact.hero.title', 'Contact Musikuli Dairies Limited')}</h1>
        <p>{getVal('contact.hero.subtitle', "We're here to help. Reach out via phone, email, or visit us at our farm in Luwero.")}</p>
      </div>
            ...
            <ScrollAnimation>
              <div>
                ...
                <div className="quick-actions">
                  <a href={`tel:${cleanPhone}`} className="btn btn-primary" id="contact-call-btn">
                    <PhoneCall size={18} /> Call Now
                  </a>
                  <a href={`mailto:${email}`} className="btn btn-outline" id="contact-email-btn">
                    <Mail size={18} /> Send Email
                  </a>
                  <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer" className="btn btn-green" id="contact-whatsapp-btn">
