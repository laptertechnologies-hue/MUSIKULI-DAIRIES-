...
const siteContent = [
  ...
  { key: 'about.founder_1.role', value: 'Co-Founder & Director', type: 'TEXT', page: 'about', label: 'Founder 1: Role' },
  { key: 'about.founder_1.image', value: '/images/gallery-founder-farm-1.jpg', type: 'IMAGE_URL', page: 'about', label: 'Founder 1: Photo' },
  { key: 'about.founder_2.name', value: 'Regina Nabategga', type: 'TEXT', page: 'about', label: 'Founder 2: Name' },
  { key: 'about.founder_2.role', value: 'Co-Founder & Managing Director', type: 'TEXT', page: 'about', label: 'Founder 2: Role' },
  ...
  { key: 'services.agro.image', value: '/images/bulk_warehouse_produce.png', type: 'IMAGE_URL', page: 'services', label: 'Agro Section: Main Image' },
  ...
  { key: 'services.mcc.image', value: '/images/bulk_delivery_vehicle.png', type: 'IMAGE_URL', page: 'services', label: 'MCC Section: Image' },
  { key: 'services.goat.title', value: 'Goat Enterprise', type: 'TEXT', page: 'services', label: 'Goat Section: Title' },
  { key: 'services.goat.desc', value: 'We breed and supply premium Savannah and Mubende goats. We focus on rearing and bulking live goats to supply commercial markets and breeding stock in large quantities across the region.', type: 'TEXT', page: 'services', label: 'Goat Section: Description' },
  ...
  { key: 'pricing.product_7.name', value: 'Goats', type: 'TEXT', page: 'pricing', label: 'Product 7: Name' },
  { key: 'pricing.product_7.unit', value: 'Per animal', type: 'TEXT', page: 'pricing', label: 'Product 7: Unit' },
  { key: 'pricing.product_7.note', value: 'Savannah & Mubende breeds', type: 'TEXT', page: 'pricing', label: 'Product 7: Note' },

  { key: 'pricing.product_8.name', value: '__DELETED__', type: 'TEXT', page: 'pricing', label: 'Product 8: Name' },
